...
_POLICY_FILES = (
    ...
    "policy_experimental.py", "live.py",
)
...
does — same import path, same per-decision call, nothing from the source
tree. Run in a subprocess with cwd set to the bundle so an accidental
...
deck_again = main.agent({**obs, "select": None})
