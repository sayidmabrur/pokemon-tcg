...
Usage:
    python archetypes/lucario/policy_network/test_dataset.py data/policy_decisions_lucario.parquet
    python archetypes/lucario/policy_network/test_dataset.py data/policy_decisions_lucario.parquet 20 --verbose
"""
...
# def main() -> None:
parquet_path = sys.argv[1] if len(sys.argv) > 1 else "data/policy_decisions_lucario.parquet"
