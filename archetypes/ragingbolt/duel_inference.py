...
Run it::
    ...
    python archetypes/ragingbolt/duel_inference.py --episodes 100
...
The BC policy defaults to ``ragingbolt_deck.csv``, the list reconstructed from
...
# This file lives in archetypes/ragingbolt/ (not the repo root), so the repo
...
def main() -> None:
    ...
    parser.add_argument(
        "--deck", default=str(_REPO_ROOT / "ragingbolt_deck.csv"),
