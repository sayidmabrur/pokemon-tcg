...
This archetype clones the ``James Cox & Henry Chao`` Raging Bolt ex /
Teal Mask Ogerpon ex / Mega Kangaskhan ex toolbox (Kaggle submission
55063047, 446 episodes).
...
def main() -> None:
    ...
    parser.add_argument("--parquet", default=str(_REPO_ROOT / "data/policy_decisions_ragingbolt.parquet"))
    parser.add_argument("--player-name", default="James Cox & Henry Chao")
    parser.add_argument("--card-data", default=str(_REPO_ROOT / "EN_Card_Data.csv"))
    parser.add_argument("--out", default=str(_REPO_ROOT / "ragingbolt_deck.csv"))
