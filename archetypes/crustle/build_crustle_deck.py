...
def main() -> None:
    ...
    parser.add_argument("--parquet", default=str(_REPO_ROOT / "data/policy_decisions_crustle.parquet"))
    parser.add_argument("--player-name", default="flg")
    parser.add_argument("--card-data", default=str(_REPO_ROOT / "EN_Card_Data.csv"))
    parser.add_argument("--out", default=str(_REPO_ROOT / "archetypes/crustle/crustle_deck.csv"))
