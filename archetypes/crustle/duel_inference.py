...
Run it::
    ...
    python archetypes/crustle/duel_inference.py --episodes 100
...
The BC policy defaults to ``archetypes/crustle/crustle_deck.csv``, the list reconstructed from
...
# This file lives in archetypes/crustle/ (not the repo root), so the repo
...
def main() -> None:
    ...
    parser.add_argument(
        "--deck", default=str(_REPO_ROOT / "archetypes/crustle/crustle_deck.csv"),
