...
Usage:
    python archetypes/crustle/policy_network/test_dataset.py data/policy_decisions_crustle.parquet
    python archetypes/crustle/policy_network/test_dataset.py data/policy_decisions_crustle.parquet 20 --verbose
"""
...
# def main() -> None:
parquet_path = sys.argv[1] if len(sys.argv) > 1 else "data/policy_decisions_crustle.parquet"
