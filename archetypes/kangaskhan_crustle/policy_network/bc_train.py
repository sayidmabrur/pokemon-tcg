...
# duel_inference.py lives in archetypes/kangaskhan_crustle/ (one level up from this
...
def train(
    parquet_path: str = "data/policy_decisions_kangaskhan_crustle.parquet",
    player_name: str = "Where is my orbit",
    epochs: int = 1,
    lr: float = 1e-3,
    grad_clip: float = 1.0,
    batch_size: int = 64,
    ...
    if duel_episodes > 0:
        duel_deck_path = Path(duel_deck or duel_inference._REPO_ROOT / "kangaskhan_crustle_deck.csv")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--parquet", default="data/policy_decisions_kangaskhan_crustle.parquet")
    ...
    parser.add_argument(
        ...
        help="deck for the policy in the end-of-epoch duel; defaults to kangaskhan_crustle_deck.csv",
    )
    parser.add_argument(
