...
#: in ``data/policy_decisions_kangaskhan_crustle.parquet`` (noted per field) so a rare
...
_NORMALIZATION_CAPS = {
    ...
    # scan of data/policy_decisions_kangaskhan_crustle.parquet), so headroom above that.
