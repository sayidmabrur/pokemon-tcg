...
Run it::
    ...
    python archetypes/kangaskhan_crustle/duel_inference.py --episodes 100
...
The BC policy defaults to ``kangaskhan_crustle_deck.csv``, the list reconstructed from
...
# This file lives in archetypes/kangaskhan_crustle/ (not the repo root), so the repo
...
def main() -> None:
    ...
    parser.add_argument(
        "--deck", default=str(_REPO_ROOT / "kangaskhan_crustle_deck.csv"),
